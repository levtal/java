 ...
 * between {} will execute at least once. The code is executed
 *  and
...
// It must be created before the expression is evaluated below
	 ...
	 * for( declare iterator; conditional statement; 
	...
	// System.out.println(l); The variable l is not callable 
	//outside of for

	int m, n; // You don't have to declare variables in the for 
	//loop
