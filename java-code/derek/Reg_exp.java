//package  
//https://www.youtube.com/watch?v=s_PfopWcMwI&index=19&list=PLE7E8B7F4856C9B19

/*
Regular Expressions. 
You use regular expressions when you want to search for data. 
You then use codes to define what that data looks like.

So, if you are looking for a 5 digit number, you could 
type \\d{5} and Java does the rest!
 ...
 public static void main(String[] args){
	...
	*/
	...
	// Grab any string that contains 1 or more !
		...
		regexChecker("(\\{{1,})", strangeString); // '\{'= 1 or more {
		regexChecker("(\\{+)", strangeString);// the same as above
		...
		*/
		...
		regexChecker("\\w*", strangeString);// any word
		// email address
