//https://www.youtube.com/watch?v=eNPX2pTiaHI&index=9&list=PLE7E8B7F4856C9B19
...
// You can also create the array and its values from the start
 ...
 int k = 1;
 while(k <= 41){ System.out.print('+'); k++; } // Draws 41 +  
 System.out.println();
...
int[] numberCopy = Arrays.copyOf(numberArray, 5);//copy 5 numbers
...
System.out.println(Arrays.toString(numberCopy));
		...
		System.out.println("numsToSort = "+ Arrays.toString(numsToSort));	
		// Sort the array in ascending order
		Arrays.sort(numsToSort);
		
		System.out.println("Sort array= "+Arrays.toString(numsToSort));
		...
		System.out.println("whereIs50 = "+whereIs50);
	}
