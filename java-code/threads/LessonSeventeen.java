//package threads;
//https://www.youtube.com/watch?v=F-CkaU8aQZI&list=PLE7E8B7F4856C9B19&index=17
public class LessonSeventeen{
	
 public static void main(String[] args){
 // Create a new Thread that executes the code in
//	 GetTime20
		
 Thread getTime = new GetTime20();
		
 // Create a new Thread created using the Runnable
 //interface
