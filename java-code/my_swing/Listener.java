...
public class Listener extends JFrame{
 ...
 // Create an instance of ListenForEvents 
 //to handle events
ListenForButton lForButton = new ListenForButton();
// class ListenForButton  defined at the end of this file 		


//  alerted when event occurs on the button
...
textArea1 = new JTextArea(15, 20);
 ...
 // Check if the source of the event was the button
  if(e.getSource() == button1){
    ...
    //  on the button and the event that occurred
   }//if
  }//actionPerformed
