 // The LinkedList class is a collection based on a 
// Linked List instead of an array.
// They are particularly good when you expect to p
// perform many additions and deletions with a 
...
// linked list contains a pointer to the objects 
///that proceed and follow it.
// When you change an ArrayList a new array is created 
// by it.
//Framework- a reusable set of libraries
// or classes for a software system (or subsystem) 


/*
Collections - framework that provides an 
