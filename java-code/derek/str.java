//https://www.youtube.com/watch?v=RxeDe6BsTMI&list=PLE7E8B7F4856C9B19&index=13
 ...
 */
 ...
 System.out.println("indexOf('cd')="+letters.indexOf("cd"));
...
// toString() converts the array into a String to print it 
 System.out.println("letterArray ="+Arrays.toString(letterArray));
		
 // toCharArray() inserts every character in the string into
 // separate indexes in an array 
 char[] charArray = letters.toCharArray();
   		
 System.out.println("toString(charArray)="+Arrays.toString(charArray));
