...
public class methods {
	// main is a method that contains all of the code to be executed when
 ...
 */
 ...
 // Changes to the variable d in tryToChange don't effect its 
 //	value globally
// We are passing the value of d to tryToChange and not the 
//	variable
  tryToChange(d);
 ...
 public static int addThem(int a, int b){
	...
	// compare returns 0 if equal | -1 if smallPI is less 
	//than myPI | 1 if smallPI is greater than myPI
...
// If int randomNumber was declared in this method it wouldn't 
// effect the global variable named randomNumber
