...
//www.newthinktank.com/2012/01/java-video-tutorial-11/

 
//An ArrayList differs from an array in
...
// You don't have to declare the ArrayList size 
// like you do with arrays (Default Size of 10)
 ...
 names.set(0, "John Adams");//   replace a value using the set method
 names.remove(3); // You can remove an item with remove
 ...
 // method is called
 System.out.println("System.out.println = "+ names);
			
// You can also use the enhanced for with an ArrayList
 for(String i : names){
    System.out.println("for(String i : names) =>"+i);
 }
 ...
 System.out.println(" indivItems.hasNext() ");
 while(indivItems.hasNext())			{
 // next retrieves the next item in the ArrayList
       System.out.println("||"+indivItems.next());
 }
			
 // I create an ArrayList without stating the type of 
 //values  it contains (Default is Object)
...
// addAll adds everything in one ArrayList to another
 ...
 names.add(paulYoung);
 // contains returns a boolean value based off of 
 //whether  the ArrayList contains the specified object
...
// toArray converts the ArrayList into an array of 
 //objects
